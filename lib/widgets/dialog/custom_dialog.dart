...
class CustomDialog {
  static void show(
    ...
    buttonsCount == 1 ? MainAxisAlignment.center : MainAxisAlignment.center;

    showDialog(
      context: context,
      barrierDismissible: dismissible,
      builder: (ctx) => backButtonBlock
          ? WillPopScope(
        onWillPop: () async => false,
        child: _buildDialog(ctx, isDark, title, message, icon, iconColor,
            positiveButtonText, negativeButtonText, onPositivePressed, onNegativePressed, buttonAlignment),
      )
          : _buildDialog(ctx, isDark, title, message, icon, iconColor,
          positiveButtonText, negativeButtonText, onPositivePressed, onNegativePressed, buttonAlignment),
    );
  }

  static Dialog _buildDialog(
      BuildContext ctx,
      bool isDark,
      String title,
      String message,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (positiveButtonText != null || negativeButtonText != null) SizedBox(height: 20),

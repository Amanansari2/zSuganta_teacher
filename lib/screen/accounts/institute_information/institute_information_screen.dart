...
class InstituteInformationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final role = context.watch<UserSessionProvider>().role.toLowerCase();
    final isUniversity = role == 'university';

    final appTitleText = isUniversity
        ? AppText.universityInformation
        : AppText.instituteInformation;

    final nameLabel = isUniversity
        ? AppText.universityName
        : AppText.instituteName;

    final nameHint = isUniversity
        ? AppText.enterUniversityName
        : AppText.enterInstituteName;

    final typeName = isUniversity
        ? AppText.universityType
        : AppText.instituteType;

    final descriptionLabel = isUniversity
        ? AppText.universityDescription
        : AppText.instituteDescription;

    final descriptionHint = isUniversity
        ? AppText.describeYourUniversity
        : AppText.describeYourInstitute;
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              CustomDropdown<FilterOption>(
                                key: ValueKey(
                                  provider.selectedInstituteType?.id,
                                ),
                                ...
                                hint: AppText.selectType,
                                isLoading:
                                    provider.instituteType.isEmpty &&
                                    provider.isLoading,
                                iconColor: dark
                                    ? AppColors.blue
                                    : AppColors.orange,
                                ...
                                validator: (value) {
                                  if (value == null)
                                    return "Institute type is required";
                                  return null;
                                },
                              ),
                            ],
                          ...
                          Column(
                            children: [
                              ...
                              CustomDropdown<FilterOption>(
                                key: ValueKey(
                                  provider.selectedInstituteCategory?.id,
                                ),
                                ...
                                isLoading:
                                    provider.instituteCategory.isEmpty &&
                                    provider.isLoading,
                                iconColor: dark
                                    ? AppColors.blue
                                    : AppColors.orange,
                              ...
                              Column(
                                children: [
                                  ...
                                  CustomDropdown<FilterOption>(
                                    key: ValueKey(
                                      provider.selectedEstablishmentYear?.id,
                                    ),
                                    items: provider.establishmentYear,
                                    selected:
                                        provider.selectedEstablishmentYear,
                                    onChanged: (val) {
                                    ...
                                    isLoading:
                                        provider.establishmentYear.isEmpty &&
                                        provider.isLoading,
                                    iconColor: dark
                                        ? AppColors.blue
                                        : AppColors.orange,
                              ...
                              Column(
                                children: [
                                  ...
                                  CustomDropdown<FilterOption>(
                                    key: ValueKey(
                                      provider.selectedTotalStudents?.id,
                                    ),
                              ...
                              Column(
                                children: [
                                  ...
                                  CustomDropdown<FilterOption>(
                                    key: ValueKey(
                                      provider.selectedTotalTeacher?.id,
                                    ),
                              ...
                              AppTextFiled(
                                controller:
                                    provider.instituteDescriptionController,
